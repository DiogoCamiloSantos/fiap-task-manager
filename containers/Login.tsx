        ...
        <div className="container-login">
            ...
            <form>
                ...
                <div className="input">
                    ...
                    <input type={ showPassword ? "text" : "password" } placeholder="Informe sua senha"value={password} onChange={evento => setPassword(evento.target.value)} />
                ...
                <label onClick={goToCreateUser}>Novo por aqui? Cadastre-se agora!</label>
            </form>
        </div>
    )
}
